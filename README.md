...
| <div align="center">3</div> | [Comprendre l'Architecture en Couches Spring Boot ](https://maxwelltbtech.substack.com/p/comprendre-larchitecture-en-couches)| <a href="https://youtu.be/PDxFdmfDD9c"><img src="img/Youtube_Thumbnail_1.png" alt="Thumbnail 3" width="400"></a>  | Integrate **Google GenAI** to power the chat interface and generate dynamic quizzes. |
