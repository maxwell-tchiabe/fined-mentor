...
| <div align="center">5</div> | [Dockeriser proprement une appli full‑stack — principes et recette pratique](https://open.substack.com/pub/maxwelltbtech/p/dockeriser-proprement-une-appli-fullstack?r=69je8w&utm_campaign=post&utm_medium=web&showWelcomeOnShare=true)| <a href="https://youtu.be/fNnt2r6RLN0"><img src="img/Youtube-Thumbnail-jour-4.png" alt="Thumbnail 5" width="400"></a> | Deep dive into the core modules: **Authentification**, **Chat**, and **Quiz** |
